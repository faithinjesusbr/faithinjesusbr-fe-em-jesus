...
import { Play, Search, Filter, ExternalLink, Clock, Eye, ArrowLeft, Video } from "lucide-react";
...
export default function YouTubeVideosImprovedPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-950 dark:to-pink-950">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        {/* Instructions */}
        <Card className="mt-8 bg-gradient-to-r from-gray-50 to-gray-100 border-none">
          <CardContent className="pt-6">
            <h3 className="font-semibold mb-3 flex items-center gap-2">
              <Video className="h-4 w-4 text-red-600" />
              Como usar a Videoteca
            </h3>
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• Clique em qualquer vídeo para assistir no YouTube</li>
              <li>• Use os filtros de categoria para encontrar temas específicos</li>
              <li>• Use a busca para localizar vídeos por título ou descrição</li>
              <li>• Compartilhe os vídeos pelo WhatsApp com um clique</li>
              <li>• Inscreva-se no canal para não perder novos conteúdos</li>
            </ul>
          </CardContent>
        </Card>
      </div>
